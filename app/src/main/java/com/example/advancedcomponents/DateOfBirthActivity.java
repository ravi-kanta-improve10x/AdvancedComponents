...
public class DateOfBirthActivity extends AppCompatActivity {
    ...
    public void setDate() {
        ...
        arrayAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, dates);
    ...
    public void setMonth() {
        ...
        stringArrayAdapter = new ArrayAdapter<>(this,R.layout.uppercase_months_item, months);
        monthSp.setAdapter(stringArrayAdapter);
        monthSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                Toast.makeText(DateOfBirthActivity.this, "Months : " + months.get(position), Toast.LENGTH_SHORT).show();
            }
    ...
    public void setYear() {
        ...
        yearSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                Toast.makeText(DateOfBirthActivity.this, "years : " + years.get(position), Toast.LENGTH_SHORT).show();
            }
